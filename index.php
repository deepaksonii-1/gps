...
<body>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="#portfolio" onclick=$("#menu-close").click();>How We Work</a>
            </li>
            <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Are you facing vehicle related problem at unknown location where you can't find any mechanic there</h2>
                    <p class="lead">Here you can find mechanics details near by you.</p>
                </div>
            </div>
            <!-- /.row -->
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <h4>
                                    <strong>All Type Vehicle Service</strong>
                                </h4>
                                <p></p>
                                <a href="#" class="btn btn-light">Learn More</a>
                            </div>
    ...
    <aside class="callout">
        <div class="text-vertical-center">
            <h1>Track Your Location. Where You Get <Service>    </Service></h1>
        </div>
    </aside>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h4><strong>Gps Service Finder</strong>
                    </h4>
                    <p>124 Mp Nagar
                        <br>Near Chetak Bridge</p>
                    <ul class="list-unstyled">
                        <li><i class="fa fa-phone fa-fw"></i> (111)111-1111</li>
                        <li><i class="fa fa-envelope-o fa-fw"></i> <a href="mailto:name@example.com">abc@gmail.com</a>
                        </li>
                    </ul>
                    <br>
                    ...
                    <hr class="small">
                    <p class="text-muted">Copyright &copy; gpsfinder.com 2014</p>
                </div>
            </div>
        </div>
